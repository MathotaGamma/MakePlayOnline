...
function touch_func(){
  ...
  //text = view_count_k0.toString();
  if(view_count_k0 != view_count_pre){
    touch_first = touch_move_list[view_value_k];
    //view_theta = 
    view_count_pre = view_count_k0;
    view_pre_theta = view_theta;
    view_pre_arg = view_arg;
    //alert('pre')
  }
  if(view_k == true){
    view_theta = view_pre_theta + view_multi*(touch_first[0]-touch_move_list[view_value_k][0]);
    view_arg = view_pre_arg - view_multi_arg*(touch_move_list[view_value_k][1]-touch_first[1]);
...
function value_set(){
  ...
  text_id.innerHTML = text.toString();
}
